...
>
  ...
  <div class="bg-white rounded-3xl p-6 max-w-2xl w-11/12 max-h-[80vh] overflow-y-auto animate-scale-in" on:click|stopPropagation on:keydown|stopPropagation role="document">
